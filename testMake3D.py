...
"""
CUDA_VISIBLE_DEVICES=0 nice -10 python3 testMake3D.py --dataset_root /newfoundland/chaoyang/kitti --ckpt_file /home/chaoyang/LKVOLearner/checkpoints/checkpoints_19_416_scratch/9_model.pth --test_file_list
"""
parser = argparse.ArgumentParser()

parser.add_argument("--dataset_root", type=str, default="/home/chaoyang/Make3D", help="dataset root path")
parser.add_argument("--test_file_list", type=str, default="/home/chaoyang/Make3D/test.txt", help="test file list")
...
for filename in test_files:
    ...
    # img_pil.save('test_images_cropped/%s.png'%(file_name))
