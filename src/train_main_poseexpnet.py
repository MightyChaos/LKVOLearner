...
sfmlearner = SfMLearner(img_size=img_size, ref_frame_idx=1,
    lambda_S=opt.lambda_S, lambda_E=opt.lambda_E,
     gpu_ids = gpu_ids, smooth_term = opt.smooth_term, use_ssim=opt.use_ssim,
     use_expl_mask=True)
